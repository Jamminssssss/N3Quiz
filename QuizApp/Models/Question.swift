...
struct Question: Hashable {
    ...
    Question(questionText:"日本には飲み物の自動販売機がたくさんある。缶コーヒーやペットボトルのお茶などは、一台の販売機で温かい物か冷たい物かを選べるので、便利だ。しかし、最初のころの自動販売機は、冷たい物しか売ることができなかった。ある冬の日、高速道路の駐車場で、トラックの運転手たちが自動販売機で買ったジュースを飲んでいた。みんなとても寒そうだったので、それを見た飲料会社の社長が、冬には温かい物を飲んでほしいと考えた。それから10年近くかけて作られたのが、今の販売機なのだそうだ。\n현재 판매기가 만들어진 왜 인지 위 문장을 읽고 네가지 보기 중에서 알맞은 것을 고르세요.",
             ...
             correctAnswerIndex: 3),
    Question(questionText:"あて先:kinkyu@oyama-daigaku.ac.jp\n件名:大雪による休講のお知らせ\n送信日時:2016年 12月1日 7:0 0\n学生のみなさん\n現在、大雪のため、多くの公共交通機関が止まっています。そのため、午前の授業は\n行われません。午後の授業は、10時までに公共交通機関が動き始めれば、いつもの通\nり行います。授業を行うかどうか10時にメールでお知らせしますので、必ず確認して\nください。なお、クラブ活動やサークル活動なども、午前中は中止してくださ.\n大山大学 事務室\n위 문장을 읽고 알수 있는것은 무엇인가?네가지 보기중에서 고르세요.",
             possibleAnswers: [
             "今日の午前の授業は、10時から始まる.",
             "午前も午後も、今日はクラブ活動を中止しなければならない。",
             "今日の午後の授業があるかどうか、10時に事務室からメールが届く。",
             "10時に事務室からメールが届いたら、今日の午後の授業はある。",
             ],
             correctAnswerIndex: 2),
    ]
}
